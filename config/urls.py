...
schema_view = get_schema_view(
    openapi.Info(
        title="Safe Price Service API",
        default_version="v1",
        description="Get fiat price for base currencies and ERC20 tokens",
...
urlpatterns_v1 = [
    path("", include("safe_price_service.tokens.urls", namespace="tokens")),
]
